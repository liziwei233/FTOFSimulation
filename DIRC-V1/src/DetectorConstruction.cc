...
G4VPhysicalVolume *DetectorConstruction::Construct()
{
    ...
    // --------------- Al --------------------
    G4Tubs *
        solidAlPlate = new G4Tubs("AlPlate", 0, SectorR2, 20., 0., 360 * deg);
    G4LogicalVolume *
        logicAlPlate = new G4LogicalVolume(solidAlPlate, Al, "AlPlate");
    G4VPhysicalVolume *physiAlPlate[2];
    physiAlPlate[0] = new G4PVPlacement(0, G4ThreeVector(0, 0, 1300), logicAlPlate, "AlPlate", logicWorld, false, 0, checkOverlaps);
    physiAlPlate[1] = new G4PVPlacement(0, G4ThreeVector(0, 0, -1300), logicAlPlate, "AlPlate", logicWorld, false, 1, checkOverlaps);
