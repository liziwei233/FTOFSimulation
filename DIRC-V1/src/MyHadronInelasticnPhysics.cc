...
void MyHadronInelasticPhysics::CreateModels()
{
...
MyHadronInelasticPhysics::~MyHadronInelasticPhysics()
{
  if (!tpdata) return;
...
void MyHadronInelasticPhysics::ConstructParticle()
{
...
void MyHadronInelasticPhysics::ConstructProcess()
{
